...
cd /root/Autoscript/addons; ./speedtest.sh

# Setting up new vps login port
echo -ne "Do you want to change the VPS login Authentication? (y/n)"; read login
...
echo -e "    ${blue}'------------------------------------------'${NC}"
echo ""
echo -e "   ${blue}Your VPS Will Be Automatical Reboot In 10 seconds${NC}"
